...
extern cons *fchareq(base_char *a, base_char *b);
extern cons *fcharequal(base_char *a, base_char *b);
extern cons *fstringeq(vector *a, vector *b);
extern cons *fstringequal(vector *a, vector *b);
